...
export const references: ReferenceBlock[] = [
  {
    ...
    note: "Premium branded bags and packaging for corporate organizations.",
    testimonial: "CoAdvert delivered exactly what we needed for our annual conference. The quality of the bags exceeded our expectations and our members loved them.",
  },
  {
    id: "storytel",
    clientName: "Storytel",
    ...
    note: "Custom branded packaging supporting media and publishing brands.",
    testimonial: "We have been working with CoAdvert for multiple campaigns and they always deliver on time with consistent quality. A reliable partner for our brand.",
  },
  {
    id: "boulebar",
    clientName: "Boulebar",
    ...
    note: "Branded takeaway and promotional packaging for hospitality businesses.",
    testimonial: "The promotional bags from CoAdvert perfectly represent our brand at every venue event. Great attention to detail and fast turnaround.",
  },
  {
    id: "demadly",
    ...
    note: "Premium paper bags and branded packaging for fashion retail.",
    testimonial: "As a fashion brand, packaging quality matters as much as the product itself. CoAdvert understands this and delivers premium bags that elevate our customer experience.",
  },
  {
    id: "tellkiddo",
    ...
    note: "Creative branded packaging for children's lifestyle products.",
    testimonial: "CoAdvert brought our playful brand identity to life through their creative packaging solutions. The bags are loved by both kids and parents alike.",
  },
  {
    id: "hsr",
    clientName: "HSR",
    ...
    note: "Custom branded bags and promotional packaging for educational organizations.",
    testimonial: "Professional service from start to finish. The branded bags for our academic outreach programme were produced to an excellent standard.",
  },
  {
    id: "alloffice",
    ...
    note: "Corporate paper bags and retail packaging solutions.",
    testimonial: "We needed reliable, high volume retail packaging and CoAdvert delivered consistently across every order. Their pricing is competitive and the quality speaks for itself.",
  },
  {
    id: "massolit",
    ...
    note: "Branded packaging tailored for publishers and media companies.",
    testimonial: "The custom tote bags for our book launches have become a favourite among our readers. CoAdvert captures our publishing identity beautifully.",
  },
  {
    id: "balder",
    clientName: "Balder",
    ...
    note: "Corporate branded bags for marketing and promotional activities.",
    testimonial: "CoAdvert provided us with high quality promotional bags that made a strong impression at our property showcase events. Excellent corporate branding partner.",
  },
  {
    id: "beckers",
    clientName: "Beckers",
    ...
    note: "Custom retail packaging designed for established brands.",
    testimonial: "Working with CoAdvert has been seamless. They understand our brand guidelines perfectly and the packaging quality matches our premium product range.",
  },
  {
    id: "reused-remade",
    ...
    note: "Sustainable packaging solutions supporting circular retail brands.",
    testimonial: "Finding a packaging partner who shares our commitment to sustainability was essential. CoAdvert's recycled cotton bags align perfectly with our circular brand values.",
  },
  {
    id: "taco-truck",
    ...
    note: "Custom takeaway bags and branded food packaging.",
    testimonial: "Our branded takeaway bags from CoAdvert are a hit with customers. They are sturdy, look fantastic, and the printing quality is top notch.",
  },
  {
    id: "fab-lab",
    clientName: "Fab Lab",
    ...
    note: "Creative packaging solutions for innovative brands and projects.",
    testimonial: "CoAdvert turned our creative vision into reality with packaging that truly stands out. Their willingness to experiment with designs made all the difference.",
  },
  {
    id: "judits",
    clientName: "Judits",
    ...
    note: "Elegant branded paper bags for premium fashion retailers.",
    testimonial: "The elegant paper bags from CoAdvert perfectly complement our fashion collections. Our customers often comment on how beautiful the packaging is.",
  },
  {
    id: "lejonkulan",
    clientName: "Lejonkulan",
    industry: "Retail & Corporate",
    region: "Nordic",
    logo: "https://res.cloudinary.com/dqgen2gxh/image/upload/v1782028667/Kopia_av_lejonkulan_logga_copy_zbbmmk.png",
    note: "Custom retail bags and promotional packaging solutions.",
    testimonial: "Reliable, professional, and always delivering great results. CoAdvert is our go to partner for all promotional packaging needs.",
  },
  {
    id: "laraforbundet",
    ...
    note: "Branded bags and promotional materials for member organizations.",
    testimonial: "CoAdvert provided excellent branded bags for our national campaigns. The quality reflects the professionalism our members expect from us.",
  },
  {
    id: "veronica-virta",
    ...
    note: "Premium branded packaging for fashion collections.",
    testimonial: "Every detail of our packaging matters and CoAdvert delivered with precision. The bags feel luxurious and truly represent our fashion brand identity.",
  },
  {
    id: "654-sthlm",
    clientName: "6/5/4 Stockholm",
    industry: "Fashion & Lifestyle",
    region: "Nordic",
    logo: "https://res.cloudinary.com/dqgen2gxh/image/upload/v1782028761/logo_654_p5c8cj.png",
    note: "Contemporary branded bags for fashion and lifestyle brands.",
    testimonial: "CoAdvert captures the contemporary spirit of our brand in every bag they produce. Fast delivery and outstanding print quality every time.",
  },
  {
    id: "ballonger-nu",
    ...
    note: "Custom event packaging and branded promotional bags.",
    testimonial: "For our events and celebrations, CoAdvert always delivers colourful, eye catching packaging on tight deadlines. A fantastic partner to work with.",
  },
  {
    id: "sabina",
    clientName: "Sabina",
    ...
    note: "Professional retail packaging and branded carrier bags.",
    testimonial: "The carrier bags from CoAdvert are consistently well made and beautifully printed. They add a professional touch to every customer purchase.",
  },
  {
    id: "nordiska-museet",
    ...
    note: "Custom museum merchandise bags and branded packaging.",
    testimonial: "Our museum gift shop bags from CoAdvert are a wonderful extension of our exhibitions. Visitors love taking home a beautifully branded piece of our heritage.",
  },
  {
    id: "granier-respons",
    ...
    note: "Corporate packaging solutions with premium brand presentation.",
    testimonial: "CoAdvert consistently delivers packaging that meets our high corporate standards. Their attention to brand consistency across every batch is impressive.",
  },
  {
    id: "sitrus",
    clientName: "Sitrus",
    ...
    note: "Branded packaging supporting creative media campaigns.",
    testimonial: "CoAdvert understands the creative industry. Their branded bags for our media campaigns are always produced to a high standard with vibrant colours.",
  },
  {
    ...
    note: "Corporate promotional bags for real estate branding.",
    testimonial: "The promotional bags for our property events were delivered on time and looked exceptional. CoAdvert is a trusted name in our marketing supply chain.",
  },
  {
    ...
    note: "Custom branded bags for books, publishing, and retail.",
    testimonial: "Our readers and book lovers adore the custom tote bags CoAdvert created for us. The print quality and fabric feel are simply outstanding.",
  },
  {
    id: "filippa-k",
    clientName: "Filippa K",
    industry: "Fashion & Retail",
    region: "Europe",
    logo: "https://res.cloudinary.com/dqgen2gxh/image/upload/v1782028007/fillipak-logo_pshzzt.png",
    note: "Luxury paper bags crafted for premium fashion brands.",
    testimonial: "CoAdvert crafts luxury paper bags that match the premium standards our brand demands. Every bag feels like an extension of our fashion collections.",
  },
  {
    id: "sanoma",
    clientName: "Sanoma",
    ...
    note: "Custom promotional packaging for publishing and media.",
    testimonial: "Across multiple European markets, CoAdvert has been our reliable packaging partner. Their ability to scale production while maintaining quality is remarkable.",
  },
  {
    id: "kpmg",
    clientName: "KPMG",
    ...
    note: "Premium corporate bags and branded business packaging.",
    testimonial: "CoAdvert meets the exacting standards we require for our global corporate events. Their professional approach and premium quality make them an ideal packaging partner.",
  },
];
