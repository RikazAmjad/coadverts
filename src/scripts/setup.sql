...
('alloffice', 'Alloffice kontorsvaruhus', 'Retail & Corporate', 'Nordic', 'https://res.cloudinary.com/dqgen2gxh/image/upload/v1782028318/AllOffice_logo_ezmpcn.png', 'Corporate merchandise and office supplies branding.', 9, false),
...
('balder', 'Balder', 'Real Estate', 'Nordic', 'https://res.cloudinary.com/dqgen2gxh/image/upload/v1782028518/Balder_logo_cmyk_EPS_r%C3%B6d_dpf5bq.png', 'Corporate promotional materials.', 11, false),
('beckers', 'Beckers', 'Manufacturing & Retail', 'Nordic', 'https://res.cloudinary.com/dqgen2gxh/image/upload/v1782028539/Beckers_Large_CMYK_idceqc.png', 'Branded materials for retail environments.', 12, false),
...
('taco-truck', 'Taco Truck', 'Food & Beverage', 'Nordic', '/images/placeholder-logo.png', 'Branded merchandise for food and beverage events.', 14, false),
('fab-lab', 'Fab Lab', 'Design & Innovation', 'Nordic', 'https://res.cloudinary.com/dqgen2gxh/image/upload/v1782028609/FABLAB_logo_qqxep0.png', 'Promotional items for design and innovation sectors.', 15, false),
...
('lejonkulan', 'Kopia av lejonkulan', 'Retail & Corporate', 'Nordic', 'https://res.cloudinary.com/dqgen2gxh/image/upload/v1782028667/Kopia_av_lejonkulan_logga_copy_zbbmmk.png', 'Custom promotional products and giveaways.', 17, false),
('kpmg', 'KPMG', 'Financial Services', 'Global', 'https://res.cloudinary.com/dqgen2gxh/image/upload/v1782028677/KPMG_Logo_White_screen_okuepo.png', 'Corporate branded merchandise for events and employees.', 18, false),
...
('veronica-virta', 'Veronica Virta', 'Fashion & Retail', 'Nordic', '/images/placeholder-logo.png', 'Premium cotton bags for fashion retail collections.', 20, false),
...
('sabina', 'Sabina', 'Retail & Corporate', 'Nordic', 'https://res.cloudinary.com/dqgen2gxh/image/upload/v1782029075/sabina_logo_gy4fwc.png', 'Corporate merchandise and branded items.', 23, false),
...
('sitrus', 'Sitrus', 'Media & Publishing', 'Nordic', '/images/placeholder-logo.png', 'Customized promotional merchandise.', 26, false),
('skandia-fastigheter', 'Skandia Fastigheter', 'Real Estate', 'Nordic', 'https://res.cloudinary.com/dqgen2gxh/image/upload/v1782029193/Skandia_Fastigheter_Logo_100_CMYK_Green_nkpe68.png', 'Corporate branding and promotional events.', 27, false),
('trafik-nostalgiska-forlaget', 'Trafik-Nostalgiska Förlaget', 'Media & Publishing', 'Nordic', 'https://res.cloudinary.com/dqgen2gxh/image/upload/v1782029241/TNF-kassen_logo_Webb_rjwqe3.png', 'Promotional tote bags for publishing and literary events.', 28, false)
ON CONFLICT (id) DO UPDATE SET
