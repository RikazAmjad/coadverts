...
('alloffice', 'Alloffice kontorsvaruhus', 'Retail & Corporate', 'Nordic', 'https://res.cloudinary.com/dqgen2gxh/image/upload/v1782028318/AllOffice_logo_ezmpcn.eps', 'Corporate merchandise and office supplies branding.', 9, false),
('massolist', 'Massolit Förlagsgrupp', 'Media & Publishing', 'Nordic', 'https://res.cloudinary.com/dqgen2gxh/image/upload/v1782028462/bag_1_u4amct.png', 'Custom promotional tote bags for publishing events.', 10, false),
('balder', 'Balder', 'Real Estate', 'Nordic', 'https://res.cloudinary.com/dqgen2gxh/image/upload/v1782028518/Balder_logo_cmyk_EPS_r%C3%B6d_dpf5bq.eps', 'Corporate promotional materials.', 11, false),
('beckers', 'Beckers', 'Manufacturing & Retail', 'Nordic', 'https://res.cloudinary.com/dqgen2gxh/image/upload/v1782028539/Beckers_Large_CMYK_idceqc.eps', 'Branded materials for retail environments.', 12, false),
('reused-remade', 'REUSED REMADE', 'Sustainability & Retail', 'Nordic', 'https://res.cloudinary.com/dqgen2gxh/image/upload/v1782029630/cropped-rsz_logo1_rwj9oz.png', 'Eco-friendly and sustainable customized bags.', 13, false),
('taco-truck', 'Taco Truck', 'Food & Beverage', 'Nordic', 'https://collection.cloudinary.com/dqgen2gxh/555f895d5ed6b1f21ee767100b484e39', 'Branded merchandise for food and beverage events.', 14, false),
('fab-lab', 'Fab Lab', 'Design & Innovation', 'Nordic', 'https://res.cloudinary.com/dqgen2gxh/image/upload/v1782028609/FABLAB_logo_qqxep0.ai', 'Promotional items for design and innovation sectors.', 15, false),
('judits', 'Judits', 'Fashion & Retail', 'Nordic', 'https://res.cloudinary.com/dqgen2gxh/image/upload/v1782028632/judits_lva88j.png', 'Retail shopping bags and promotional accessories.', 16, false),
('lejonkulan', 'Kopia av lejonkulan', 'Retail & Corporate', 'Nordic', 'https://res.cloudinary.com/dqgen2gxh/image/upload/v1782028667/Kopia_av_lejonkulan_logga_copy_zbbmmk.bmp', 'Custom promotional products and giveaways.', 17, false),
('kpmg', 'KPMG', 'Financial Services', 'Global', 'https://res.cloudinary.com/dqgen2gxh/image/upload/v1782028677/KPMG_Logo_White_screen_okuepo.eps', 'Corporate branded merchandise for events and employees.', 18, false),
('laraforbundet', 'Lärarförbundet', 'Education & Unions', 'Nordic', 'https://res.cloudinary.com/dqgen2gxh/image/upload/v1782028704/L%C3%A4raf%C3%B6rbundet_color_logo_kfxhqq.png', 'Branded cotton bags for union members and campaigns.', 19, false),
('veronica-virta', 'Veronica Virta', 'Fashion & Retail', 'Nordic', 'https://collection.cloudinary.com/dqgen2gxh/da4d7bba428c7d0a98f4dc088b4f0d1b', 'Premium cotton bags for fashion retail collections.', 20, false),
('654-sthlm', '6/5/4 sthlm', 'Fashion & Lifestyle', 'Nordic', 'https://res.cloudinary.com/dqgen2gxh/image/upload/v1782028761/logo_654_p5c8cj.png', 'Custom promotional gear for retail boutique in Stockholm.', 21, false),
('ballonger-nu', 'Ballonger.nu', 'Events & Entertainment', 'Nordic', 'https://res.cloudinary.com/dqgen2gxh/image/upload/v1782029044/pink_logo_pzn7ub.png', 'Event promotional materials and customized bags.', 22, false),
('sabina', 'Sabina', 'Retail & Corporate', 'Nordic', 'https://res.cloudinary.com/dqgen2gxh/image/upload/v1782029075/sabina_logo_gy4fwc.tiff', 'Corporate merchandise and branded items.', 23, false),
('nordiska-museet', 'Nordiska Museet', 'Arts & Culture', 'Nordic', 'https://res.cloudinary.com/dqgen2gxh/image/upload/v1782029102/Screen_Shot_2017-02-20_at_15.39.42_trvf4z.png', 'Custom tote bags for museum gift shops and exhibitions.', 24, false),
('granier-respons', 'Granier respons', 'Retail & Corporate', 'Nordic', 'https://res.cloudinary.com/dqgen2gxh/image/upload/v1782029135/Screen_Shot_2017-02-21_at_22.09.38_xvsgwl.png', 'Corporate promotional items.', 25, false),
('sitrus', 'Sitrus', 'Media & Publishing', 'Nordic', 'https://collection.cloudinary.com/dqgen2gxh/d03e2e8b4db50fb0f82a5a140f866b14', 'Customized promotional merchandise.', 26, false),
('skandia-fastigheter', 'Skandia Fastigheter', 'Real Estate', 'Nordic', 'https://res.cloudinary.com/dqgen2gxh/image/upload/v1782029193/Skandia_Fastigheter_Logo_100_CMYK_Green_nkpe68.eps', 'Corporate branding and promotional events.', 27, false),
('trafik-nostalgiska-forlaget', 'Trafik-Nostalgiska Förlaget', 'Media & Publishing', 'Nordic', 'https://res.cloudinary.com/dqgen2gxh/image/upload/v1782029241/TNF-kassen_logo_Webb_rjwqe3.ai', 'Promotional tote bags for publishing and literary events.', 28, false)
ON CONFLICT (id) DO UPDATE SET
